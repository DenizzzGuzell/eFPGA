You can verilate 20x20 tile size eFPGA using Makefile under eFPGA_20x20/sim. It currently requires more than 45 GB system memory tracing only top module using --trace-underscore flag.
